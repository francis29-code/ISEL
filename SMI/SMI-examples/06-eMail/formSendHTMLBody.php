...
<h1>Send an authenticated HTML e-mail using PHP</h1>

<form action="processFormSendHTML.php" method="post" target="_blank">
    <table>
        <tr>
            <td>
                * Account:
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="text" size="90" name="toList">
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td>
                <textarea name="message" rows="4" cols="50">This is a test.</textarea>
            </td>
        </tr>
    </table>
    <br>
