...
<h1>Send an authenticated e-mail using PHP</h1>

<form action="processFormSend.php" method="post" target="_blank">
    <table>
        <tr>
            <td>
                * Account:
    ...
    Show SMTP protocol: <input type="checkbox" name="showSMTP"><br><br>
