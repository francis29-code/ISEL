...
class ControloAprendRef(Controlo):
    ...
    def processar(self, percepcao):
        ...
        ################################################################
        noTarget = True;
        for imagem in percepcao.imagem:
            #caso se verifique que ainda existe alvo no ambiente, continua-se a procura
            if percepcao.imagem.get(imagem) == "alvo":
                noTarget = False
        ...
        self._a = self._mec_aprend.selecionar_accao(sn)
        self._s = sn
        self.mostrar()
        return an
